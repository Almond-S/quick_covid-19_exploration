...
## Worldwide overview of confirmed COVID-19 cases
...
fig_confirmed <- figs[[1]]
fig_confirmed %<>% layout(title = title_confirmed)
fig_confirmed %<>% htmlwidgets::appendContent(htmltools::tags$p(caption))
fig_confirmed %>% saveWidget("covid-19-time-series-confirmed.html")
```

## Worldwide overview of COVID-19 count time series with deaths and recovered
...
fig_all %<>% htmlwidgets::appendContent(htmltools::tags$p(caption))
fig_all %>% saveWidget("covid-19-time-series-all.html")
```
...
fig_all %>% saveWidget("covid-19-time-series-all-log.html")
```
